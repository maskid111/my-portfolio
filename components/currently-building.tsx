      ...
      <div className="max-w-6xl mx-auto">
        ...
        />
          ...
          <motion.div className="mb-[clamp(2rem,4vw,3rem)]" variants={animations.directionalItemVariants} custom={0}>
            ...
            <h2 className="heading-section mt-[clamp(0.75rem,1.5vw,1rem)] text-white">
              Currently Building
            </h2>
          </motion.div>
          ...
          >
            ...
            <motion.div
              className="absolute -inset-2 bg-gradient-to-br from-violet-500/16 to-blue-500/16 rounded-[clamp(0.75rem,2vw,1.5rem)] opacity-0 group-hover:opacity-30 blur-xl pointer-events-none transition-opacity duration-300 z-0"
            />
            ...
            <div className="relative z-10 grid grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
              ...
              <motion.div className="flex flex-col" variants={animations.directionalItemVariants} custom={2}>
                <div className="eyebrow mb-[clamp(0.5rem,1vw,0.75rem)]">
                  Main Project
                </div>
                ...
                <motion.div
                  className="mt-[clamp(1rem,2vw,1.5rem)] inline-flex items-center px-[clamp(0.75rem,1.5vw,1rem)] py-[clamp(0.375rem,0.75vw,0.5rem)] rounded-full bg-violet-500/12 text-violet-200 text-[clamp(0.65rem,1.2vw,0.75rem)] font-semibold border border-violet-300/25 w-fit"
                  animate={{ borderColor: ['rgba(196, 181, 253, 0.22)', 'rgba(147, 197, 253, 0.42)', 'rgba(196, 181, 253, 0.22)'] }}
                  transition={{ duration: 3, repeat: Infinity }}
                >
                  <motion.span
                    className="w-[clamp(0.375rem,0.8vw,0.5rem)] h-[clamp(0.375rem,0.8vw,0.5rem)] bg-blue-300 rounded-full mr-[clamp(0.375rem,0.75vw,0.5rem)]"
              ...
              <motion.div className="flex flex-col" variants={animations.directionalItemVariants} custom={3}>
                <div className="eyebrow mb-[clamp(0.75rem,1.5vw,1rem)]">
                  Tech Stack
                </div>
              ...
              <motion.div className="col-span-2 flex flex-col lg:col-span-1" variants={animations.directionalItemVariants} custom={4}>
                ...
                <div className="space-y-[clamp(0.75rem,1.5vw,1rem)]">
                  {activities.map((activity, idx) => (
                    <motion.div
                      key={idx}
                      className="flex items-start gap-[clamp(0.75rem,1.5vw,1rem)] p-[clamp(0.75rem,1.5vw,1rem)] rounded-lg bg-violet-500/5 hover:bg-violet-500/10 transition-colors"
                      whileHover={{ x: 4 }}
                      transition={{ type: 'spring', stiffness: 300 }}
                    >
                      <activity.icon className="w-[clamp(1.25rem,2vw,1.5rem)] h-[clamp(1.25rem,2vw,1.5rem)] text-violet-300 flex-shrink-0 mt-[clamp(0.125rem,0.25vw,0.25rem)]" />
          ...
          <motion.div className="mt-[clamp(1.5rem,3vw,2rem)]" variants={animations.directionalItemVariants} custom={5}>
            <motion.div
              className="glass rounded-[clamp(0.75rem,2vw,1rem)] p-[clamp(1rem,2vw,1.5rem)] inline-block hover:bg-violet-500/10 transition-colors"
              whileHover={{ scale: 1.05 }}
            >
              <p className="text-[clamp(0.85rem,1.8vw,1rem)] text-gray-300">
                <span className="text-violet-300 font-semibold">Available for:</span> {profile.contactFor.join(', ')}
              </p>
            </motion.div>
          </motion.div>
        </motion.div>
