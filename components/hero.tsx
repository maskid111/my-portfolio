        ...
        <motion.div className="flex w-full max-w-xl flex-col gap-2 sm:gap-5 md:block md:space-y-8" variants={animations.itemVariants}>
          ...
          >
            ...
            >
              <Button
                variant="outline"
                className="w-full sm:w-auto glass h-8 sm:h-10 md:h-12 px-2.5 sm:px-5 md:px-8 font-semibold border border-white/20 text-white hover:bg-white/10 hover:border-white/40 rounded-md sm:rounded-xl text-[clamp(0.65rem,1.6vw,1rem)] transition-all duration-300"
                size="lg"
              >
                Follow on X
              </Button>
