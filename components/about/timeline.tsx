    ...
    <section className="py-[clamp(2.5rem,5vw,5rem)] px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="heading-section mt-[clamp(0.75rem,1.5vw,1rem)]">My Timeline</h2>
        </motion.div>
        ...
        <div className="space-y-[clamp(2rem,3vw,2.5rem)] relative">
          ...
          <motion.div
            className="absolute left-[clamp(0.5rem,-2.5vw,0.75rem)] md:left-1/2 top-0 bottom-0 w-px bg-gradient-to-b from-blue-500 via-violet-500 to-sky-500 opacity-30"
            ...
            >
              ...
              <div className={`pl-[clamp(2rem,4vw,3rem)] md:pl-0 md:w-1/2 ${index % 2 === 1 ? 'md:pr-12 md:text-right' : 'md:pl-12'}`}>
                <motion.div
                  ...
                  whileHover={{ y: -4 }}
                >
                  <span className="text-blue-300 font-bold text-[clamp(1rem,2vw,1.25rem)]">{event.year}</span>
